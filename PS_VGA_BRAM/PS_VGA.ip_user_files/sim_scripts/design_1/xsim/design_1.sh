...
elaborate()
{
  xelab --relax --debug typical --mt auto -wto 1bc668d3059c4e70ad4ef4b575723492 -m64 -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_8 -L xil_defaultlib -L blk_mem_gen_v8_3_1 -L generic_baseblocks_v2_1_0 -L fifo_generator_v13_0_1 -L axi_data_fifo_v2_1_6 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_7 -L axi_protocol_converter_v2_1_7 -L unisims_ver -L unimacro_ver -L secureip --snapshot design_1 xil_defaultlib.design_1 xil_defaultlib.glbl -log elaborate.log
}
